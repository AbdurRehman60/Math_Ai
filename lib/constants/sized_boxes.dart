...
class SizedBoxes {
  ...
  static SizedBox vertical5Px = const SizedBox(height: 5);
  ...
  static SizedBox vertical22Px = const SizedBox(height: 22);
  static SizedBox vertical26Px = const SizedBox(height: 26);
  static SizedBox vertical25Px = const SizedBox(height: 25);
  ...
  static SizedBox horizontal26Px = const SizedBox(width: 26);
